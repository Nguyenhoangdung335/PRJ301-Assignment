        ...
        <nav class="navbar navbar-light bg-white navbar-expand-xl">
            ...
            <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a id="nav-shop" href="/DispatchServlet?btAction=search&type=all" class="nav-item nav-link">Shop</a>
                ...
                <div class="d-flex m-3 me-0" id="user_space">
                    ...
                    <c:if test="${not empty sessionScope.user}">
                        <div class="navbar-nav mx-auto left-auto">
                            <a href="DispatchServlet?btAction=user" class="nav-item" id="user_username">
