...
public class ProductUpdateServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Object[] params = {id, category, name, description, imageLink, inStock, price, productType};
            
            ProductDetailDAO pdDao = ProductDetailDAO.getInstance();
            if(pdDao.updateInfo(params)) {
                json.put("message", "Update product successfully");
            } else
                json.put("message", "Update product unsuccessfully, please wait while the staffs are fixing!");
