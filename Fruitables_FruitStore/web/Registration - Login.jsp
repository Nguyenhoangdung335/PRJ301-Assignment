    ...
    <body>
        ...
        <main>
            ...
            <form id="Register" method="post" action="DispatchServlet">
                ...
                <input class="field" type="password" name="txtPassword" placeholder="xxxxxxxx" value="" minlength="6" required>
                <h3 class="Regist_header">Confirm your password:</h3>
                <input class="field" type="password" placeholder="xxxxxxxx" required>
                ...
                <div class="Confirmation">
                    ...
                    <p>
                        By clicking Continue, I agree to this website's <a href="../Privacy Policy - Legal Terms/Fruitable - Privacy Policy.html">terms and policies</a>
                ...
                <section id="Registration_buttons">
                    <button class="Regist_button" type="submit" name="btAction" value="home"><a id="Regist_button_link">Back to home page</a></button>
                    <button class="Regist_button" type="submit" formaction="FunctionDispatchServlet" name="btAction" value="register" id="continue">
            ...
            <form id="LogIn" class="show-hide">
                ...
                <section id="Registration_buttons">
                    <button class="LogIn_button" type="button" name="btAction" value="home"><a id="Regist_button_link">Back to home page</a></button>
                    <button class="LogIn_button" type="submit" formaction="FunctionDispatchServlet" name="btAction" value="login" id="LogIn-button-fit">
                        <span class="material-symbols-outlined"></span>
                        Log in
                    </button>
                </section>
            </form>
            <form><input type="hidden" value="${state}"></form>
        </main>
        ...
        <script src="js/SubmitOnReloading.js"></script>
    </body>
    <!--End page-->
</html>